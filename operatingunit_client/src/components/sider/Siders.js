...
export const ManagerSider = ({children, breadcrumb, header, defaultKey}) => {
    ...
    const menuItems = [
        ...
        (userRole === managerMenuItems.users.general_manager.key ||
            userRole === managerMenuItems.users.admin.key) &&
        getItem(managerMenuItems.workers.label,
            managerMenuItems.workers.key,
            <TeamOutlined/>),
        getItem(
        ...
        (userRole === managerMenuItems.users.general_manager.key ||
            userRole === managerMenuItems.users.admin.key) &&
        getItem(
            managerMenuItems.analysis.main.label,
            managerMenuItems.analysis.main.key,
            <AreaChartOutlined />,
            [
                getItem(
                    managerMenuItems.analysis.worker.label,
                    managerMenuItems.analysis.worker.key
                ),
                getItem(
                    managerMenuItems.analysis.room.label,
                    managerMenuItems.analysis.room.key
                ),
                getItem(
                    managerMenuItems.analysis.operations.label,
                    managerMenuItems.analysis.operations.key
                )
            ],
        ),
        (userRole === managerMenuItems.users.general_manager.key ||
